"""\nInterfaz Gráfica para Clasificador de Frutas y Verduras\nAplicación Tkinter que permite clasificar imágenes en tiempo real.\n"""
...
class ImprovedFruitPredictorUI:
    """
    Interfaz gráfica para clasificar imágenes de frutas y verduras.
    
    Permite al usuario cargar imágenes y obtener predicciones con
    visualización de confianza y probabilidades.
    """
    def __init__(self, model_path):
        """
        Inicializa la interfaz gráfica y carga el modelo entrenado.
        
        Args:
            model_path: Ruta al archivo .pkl con el modelo entrenado
        """
        self.model = None
        self.scaler = None
    ...
    def load_model(self, filepath):
        """Carga el modelo entrenado y el scaler desde un archivo pickle"""
        try:
    ...
    def setup_ui(self):
        """Crea la interfaz gráfica con todos los componentes visuales"""
        self.root = tk.Tk()
        self.root.title("Fruit vs Vegetable")
    ...
    def browse_file(self):
        """Abre diálogo para seleccionar una imagen del sistema de archivos"""
    ...
    def reset_result_display(self):
        """Limpia el área de resultados a su estado inicial"""
    ...
    def _load_and_process_image(self, img_path):
        """
        Carga una imagen, la preprocesa y extrae sus características.
        
        Returns:
            numpy.ndarray: Características escaladas listas para predicción
        """
        ...
        # Extraer características (color, textura, forma, estadísticas)
    ...
    def predict_image(self):
        """
        Realiza la predicción sobre la imagen seleccionada.
        Extrae características y usa el modelo para clasificar.
        """
        ...
        try:
            ...
            # Interpretar resultados (0=Fruta, 1=Verdura)
    ...
    def display_result(self, category, confidence, fruit_prob, veg_prob):
        """
        Muestra el resultado de la predicción con elementos visuales.
        
        Args:
            category: 'Fruit' o 'Vegetable'
            confidence: Nivel de confianza [0, 1]
            fruit_prob: Probabilidad de ser fruta
            veg_prob: Probabilidad de ser verdura
        """
